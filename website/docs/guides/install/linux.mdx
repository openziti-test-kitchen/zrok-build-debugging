...
:::info
To run zrok as an always-on service, see the [Linux Agent Service guide](../../guides/agent/linux-service.mdx) or the [Docker guide](../../guides/docker-share/index.mdx).
:::
