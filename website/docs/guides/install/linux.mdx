...
:::info
To run `zrok2` as an always-on service, see the [Linux Agent Service guide](../../guides/agent/linux-service.mdx) or the [Docker guide](../../guides/docker-share/index.mdx).
:::
